...
//
//         // Comparative metrics
//         popularityRank: performanceRanking.popularityRank || 0,
//         revenueRank: performanceRanking.revenueRank || 0,
//         productCountRank: performanceRanking.productCountRank || 0,
//         performanceVsAverage: performanceRanking.performanceVsAverage || 0,
//         marketSharePercent: performanceRanking.marketSharePercent || 0,
//
//         // Metadata
...
//   ): Promise<CategoryPerformanceComparisonDto> {
//     const startTime = Date.now();
//     this.logger.log(
...
//       const comparison: CategoryPerformanceComparisonDto = {
...
//    */
//   private async buildCategoryAnalyticsQuery(
//     request: AnalyticsRequestDto,
//   ): Promise<Category[]> {
