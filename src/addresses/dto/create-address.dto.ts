...
export class CreateAddressDto {
  @ApiProperty({ example: 'Home', description: 'Label for the address (e.g. Home, Office)' })
  @IsOptional()
  @IsString()
  @MaxLength(32)
  label?: string;
  ...
  @ApiProperty({ example: 'Al-Sinaa Street, Building 12', description: 'Main address line' })
  @IsNotEmpty()
  @IsString()
  @MaxLength(128)
  addressLine1: string;
  ...
  @ApiProperty({ example: '+963991234567', description: 'Contact phone for delivery' })
  @IsNotEmpty()
  @IsPhoneNumber()
  phone: string;
